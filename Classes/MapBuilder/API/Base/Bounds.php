 ...
 */
class Tx_AdGoogleMaps_MapBuilder_API_Base_Bounds {
	 ...
	 * Constructor.
	 * 
	 * @param Tx_AdGoogleMaps_MapBuilder_API_Base_LatLng $southWest
	 * @param Tx_AdGoogleMaps_MapBuilder_API_Base_LatLng $northEast
	 */
	public function __construct(Tx_AdGoogleMaps_MapBuilder_API_Base_LatLng $southWest = NULL, Tx_AdGoogleMaps_MapBuilder_API_Base_LatLng $northEast = NULL) {
	 ...
	 * @return void
	 */
	public function setSouthWest(Tx_AdGoogleMaps_MapBuilder_API_Base_LatLng $southWest) {
		$this->southWest = $southWest;
	}
	 ...
	 * @return void
	 */
	public function setNorthEast(Tx_AdGoogleMaps_MapBuilder_API_Base_LatLng $northEast) {
		$this->northEast = $northEast;
	}
	 ...
	 * 
	 * @param Tx_AdGoogleMaps_MapBuilder_API_Base_LatLng $latLng
	 * @return void
	 */
	public function extend(Tx_AdGoogleMaps_MapBuilder_API_Base_LatLng $latLng) {
