 ...
 */
abstract class Tx_AdGoogleMaps_MapBuilder_API_Service_AbstractService implements Tx_AdGoogleMaps_MapBuilder_API_Service_ServiceInterface {
	 ...
	 * @return void
	 */
	public function mergeOptionsWithObject(array $options = array()) {
