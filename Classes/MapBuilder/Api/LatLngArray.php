 ...
 * @api
 */
class Tx_AdGoogleMaps_MapBuilder_Api_LatLngArray {

	/**
	 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_AdGoogleMaps_MapBuilder_Api_LatLng>
	 */
	 ...
	 * Constructor.
	 * $latLngArray can be 
	 * - a Tx_Extbase_Persistence_ObjectStorage of Tx_AdGoogleMaps_MapBuilder_Api_LatLng objects, 
	...
	public function setLatLngArray($latLngArray) {
		if ($latLngArray instanceof Tx_Extbase_Persistence_ObjectStorage) {
			...
			throw new Tx_AdGoogleMaps_Exception('Invalid property value for Tx_AdGoogleMaps_MapBuilder_Api_LatLngArray::setLatLngArray().', 1294069158);
		}
	}
	 ...
	 *
	 * @return Tx_Extbase_Persistence_ObjectStorage<Tx_AdGoogleMaps_MapBuilder_Api_LatLng>
	 */
	...
	public function addLatLng($latLng) {
		return $this->latLngArray->attach(new Tx_AdGoogleMaps_MapBuilder_Api_LatLng($latLng));
	}
	 ...
	 * @return void
	 */
	public function removeLatLng(Tx_AdGoogleMaps_MapBuilder_Api_LatLng $latLng) {
