 ...
 * @api
 */
class Tx_AdGoogleMaps_MapBuilder_GoogleMaps {
	...
	public function __construct() {
		...
		$this->pluginOptions = t3lib_div::makeInstance('Tx_AdGoogleMaps_MapBuilder_Options');

		// Set required plugin settings.
		$this->geocodeUrl = $this->settings['geocodeUrl'];

		Tx_AdGoogleMaps_Utility_FrontEnd::includeFrontEndResources('Tx_AdGoogleMaps_MapBuilder_GoogleMaps');
	}
	 ...
	 *
	 * @param Tx_AdGoogleMaps_MapBuilder_Options $pluginOptions
	 * @return Tx_AdGoogleMaps_MapBuilder_GoogleMaps
	 */
	public function setPluginOptions(Tx_AdGoogleMaps_MapBuilder_Options $pluginOptions) {
	...
	public function getPluginOptionsObjectIdentifier() {
		return $this->mapId ? 'Tx_AdGoogleMaps_MapBuilder_Options_Uid' . $this->mapId : 'Tx_AdGoogleMaps_MapBuilder_Options';
	}
	...
	public function getPluginMapObjectIdentifier() {
		return $this->mapId ? 'Tx_AdGoogleMaps_MapBuilder_Map_Uid' . $this->mapId : 'Tx_AdGoogleMaps_MapBuilder_Map';
	}
