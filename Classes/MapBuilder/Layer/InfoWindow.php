...
class Tx_AdGoogleMaps_MapBuilder_Layer_InfoWindow extends Tx_AdGoogleMaps_MapBuilder_Layer_AbstractLayer {
	...
	public function buildItemPreProcessing() {
		...
		$this->infoWindowRenderConfiguration = class_exists('Tx_Extbase_Service_TypoScriptService')
			? t3lib_div::makeInstance('Tx_Extbase_Service_TypoScriptService')->convertPlainArrayToTypoScriptArray($this->infoWindowRenderConfiguration)
			: Tx_Extbase_Utility_TypoScript::convertPlainArrayToTypoScriptArray($this->infoWindowRenderConfiguration);
