...
class Tx_AdGoogleMaps_MapBuilder_Options {
	...
	public function __construct() {
		...
		$this->mapControl = t3lib_div::makeInstance('Tx_AdGoogleMaps_MapBuilder_Options_MapControl');
	 ...
	 * @return Tx_AdGoogleMaps_MapBuilder_Options
	 */
	public function addLayerOptions(Tx_AdGoogleMaps_MapBuilder_Options_Layer_LayerInterface $layerOptions) {
	...
	public function getPrint() {
		if ($this->mapControl->isUseMarkerCluster() === TRUE) {
			Tx_AdGoogleMaps_Utility_FrontEnd::includeFrontEndResources('Tx_AdGoogleMaps_MapBuilder_Options');
		}
