 ...
 */
Tx_AdGoogleMaps_MapBuilder = function(options){
	this.construct(options);
};
Tx_AdGoogleMaps_MapBuilder.prototype = {
	options: null,
	canvasId: null,
	canvas: null,
	...
	construct: function(options){
		...
		if (this.mapControl.useMarkerCluster === true){
			if (typeof(MarkerClusterer) === 'undefined'){
				...
				console.log('Error Tx_AdGoogleMaps_MapBuilder.construct(): MarkerClusterer Lib not loaded.');
			} else {
	...
	setLayer: function(layerUid, layerOptions){
		return this.layers[layerUid] = new Tx_AdGoogleMaps_MapBuilder_LayerObject(layerOptions);
	},
 ...
 * Layer object.
 */
Tx_AdGoogleMaps_MapBuilder_LayerObject = function(options){
	this.construct(options);
};
Tx_AdGoogleMaps_MapBuilder_LayerObject.prototype = {
	options: null,
	layer: null,
	center: null,
	bounds: null,
 ...
 * Marker Extension.
 */
Tx_AdGoogleMaps_MapBuilder.prototype.drawMarker = function(layerIndex){
	var _this = this;
	var layerOptions = this.getLayerOptions(layerIndex);
	var layerUid = layerOptions.uid;
	// Set layer object.
